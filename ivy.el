...
(defvar ivy-minibuffer-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map [remap minibuffer-keyboard-quit] #'abort-recursive-edit)
    (define-key map [remap exit-minibuffer] #'ivy-done)
    (define-key map [remap minibuffer-beginning-of-buffer] #'ivy-beginning-of-buffer)
    ...
    (define-key map [remap previous-matching-history-element] #'ivy-reverse-i-search)
    ...
    (define-key map [remap next-line-or-history-element] #'ivy-next-history-element)
    (define-key map [remap previous-line-or-history-element] #'ivy-previous-history-element)
    ...
    (ivy-define-key map (kbd "M-A") 'ivy-dispatching-call)
    (ivy-define-key map (kbd "M-r") 'ivy-toggle-regexp-quote)
    (ivy-define-key map (kbd "M-w") 'ivy-yank-word)
    ...
    (ivy-define-key map (kbd "M-a") 'ivy-dispatching-done)
    ...
    (ivy-define-key map (kbd "M-o") 'ivy-occur)
